...
public class Processor {
	...
	public CacheLi getcacheLi() {
		return cacheLi;
	}

	public void setcacheLi(CacheLi cacheLi) {
		this.cacheLi = cacheLi;
	}

	public CacheLd getcacheLd() {
		return cacheLd;
	}

	public void setcacheLd(CacheLd cacheLd) {
		this.cacheLd = cacheLd;
	}
