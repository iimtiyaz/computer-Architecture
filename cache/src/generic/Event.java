...
public class Event {
	...
	public enum EventType {ExecutionComplete, MemoryRead, MemoryResponse, MemoryWrite, StoreEvent, CacheRead, CacheResponse, CacheReadData, CacheResponseData, CacheWrite, CacheResponseWrite};
