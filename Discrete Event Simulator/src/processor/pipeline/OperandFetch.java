...
public class OperandFetch {
	...
	{
		//System.out.println("op4 "+IF_OF_Latch.isOF_enable());
		if(IF_OF_Latch.isOF_enable())
		{
			System.out.println("-----I am in OF Stage-----");
			...
			int rs1=-1,rs2=-1,rd=-1,rd1=0,rd2=0;//Simulator.incrementInstruction();
			...
			//System.out.println("get "+OF_EX_Latch.getopcode());
			...
			//System.out.println("rs1_ = "+rs1_+" rs2_ = "+rs2_+"rd_ = "+rd_);
			//System.out.println("OF queue "+OF_EX_Latch.get_rd_values());
			if(rd_values.contains(rs1_) || rd_values.contains(rs2_) || rd_values.contains(rd_)){
				System.out.println("data haz");
